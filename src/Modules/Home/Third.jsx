...
function Third() {
    return(
        <div className="w-full mx-auto px-4 sm:px-4 md:px-4 lg:px-4 xl:px-14 pt-[1px] pb-[25px] bg-[#f4f4f7]">
          <section>
            <div className="container mx-auto p-0 sm:p-0 md:p-0 lg:p-0 xl:p-8 ">

                <div className="w-[100%] m-auto pb-[50px] relative">
                  <h2 className="text-center text-[87px] sm:text-[87px] md:text-[97px] lg:text-[105px] xl:text-[225px] text-[#e5e5e5] font-primary-head font-bold">Works</h2>
                  
                    <div className="absolute top-[38px] sm:top-[45px] md:top-[55px] lg:top-[65px] xl:top-[175px] w-[100%]">
                      ...
                      <h5 className="font-primary-head font-medium text-[23px] sm:text-[23px] md:text-[23px] lg:text-[23px] xl:text-[35px] text-center">Done Projects</h5>
                    </div>
  ...
  rel="noopener noreferrer" className="text-[#728f15] hover:text-[#a434cc] border-[1px] flex items-center px-4 py-2.5 w-[70%] md:w-[85%] mt-2 shadow-[0px_4px_6px_0px_rgba(0,_0,_0,_0.1)]">View Project <IoIosArrowRoundForward size={21} className="ml-[15px]" /></a>
                            </div>
                        </div>
                    ))}
                </div>
