...
import Chiran from '../../assets/Chiran.webp';
import Button from '../../Components/Button';
import HireB from '../../Components/HireB';
        ...
        <div className="bg-[#f4f4f7] w-[100%] m-auto px-4 sm:px-4 md:px-4 lg:px-14">
            ...
            <div className='w-[100%] sm:w-[100%] md:w-[100%] lg:w-[48%] xl:w-[50%] relative pt-[35px] sm:pt-[35px] md:pt-[35px] lg:pt-[35px] xl:pt-[75px] '>
                ...
                <div className='pl-[55px] sm:pl-[55px] md:pl-[55px] lg:pl-[55px] xl:pl-[75px]'>
                  <div className='flex flex-col sm:flex-row md:flex-row lg:flex-row gap-x-5'>
                  <HireB title="Download Resume"/>
            ...
            <div className='w-[100%] sm:w-[100%] md:w-[100%] lg:w-[48%] xl:w-[50%] relative'>
                <img src={Chiran} alt="chiranjivi" className='max-w-full h-auto float-none sm:float-none md:float-none lg:float-none xl:float-right flex items-center m-auto'/>
            </div>
            </div>
            </section>
        </div>
